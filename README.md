...
Packages	Version	
bit64	4.0.5	
car	3.0-2	# can be installed by .yml file
data.table	1.12.2	# can be installed by .yml file
dplyr	1.0.5	# can be installed by .yml file
genio	1.0.12	
ggplot2	3.3.3	# can be installed by .yml file
gridExtra	2.3	# can be installed by .yml file
gsubfn	0.7	
gt	0.2.2	# can be installed by .yml file
gtsummary	1.4.0	# can be installed by .yml file
Hmisc	4.2-0	# can be installed by .yml file
ieugwasr	0.1.5	
imputeMissings	0.0.3	# can be installed by .yml file
matchmaker	0.1.1	
MendelianRandomization	0.5.1	
oem	2.0.9	# can be installed by .yml file
openxlsx	4.1.0	# can be installed by .yml file
parallel	3.6.1	
patchwork	1.1.1	# can be installed by .yml file
pheatmap	1.0.12	# can be installed by .yml file
plotROC	2.2.1	# can be installed by .yml file
randomForest	4.6-14	# can be installed by .yml file
RColorBrewer	1.1-2	# can be installed by .yml file
rcompanion	2.4.0	
regclass	1.6	
ROSE	0.0-3	# can be installed by .yml file
sgPLS	1.7	# can be installed by .yml file
snpStats	1.36.0	
tictoc	1	
tidyverse	1.3.0	# can be installed by .yml file
utils	3.6.1	
VennDiagram	1.6.20	# can be installed by .yml file
